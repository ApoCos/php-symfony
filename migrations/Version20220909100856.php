 ...
 */
final class Version20220909100856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC273256915B FOREIGN KEY (relation_id) REFERENCES categorie (id)');
